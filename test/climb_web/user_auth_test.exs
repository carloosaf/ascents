defmodule ClimbWeb.UserAuthTest do
  use ClimbWeb.ConnCase, async: true

  alias Climb.Accounts
  alias Climb.Accounts.Scope
  alias ClimbWeb.UserAuth

  import Climb.AccountsFixtures

  @remember_me_cookie "_climb_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ClimbWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
