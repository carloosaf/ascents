defmodule Ascents.Accounts.User do
  use Ecto.Schema
  ...
  @doc """
  A user changeset for changing public member profile fields.
  """
  def profile_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:username, :display_name, :bio, :avatar_object_key])
    |> validate_username(opts)
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Ascents.Repo)
  ...
  defp validate_username(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:username, Ascents.Repo)
  ...
  """
  def valid_password?(%Ascents.Accounts.User{hashed_password: hashed_password}, password)
