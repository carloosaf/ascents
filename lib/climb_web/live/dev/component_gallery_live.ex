defmodule ClimbWeb.Dev.ComponentGalleryLive do
  use ClimbWeb, :live_view

  alias Climb.Accounts
  alias Climb.Accounts.Scope
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div id="component-gallery" class="space-y-8">
        <section class="grid items-start gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div class="chalk-panel relative overflow-hidden rounded-lg border border-climb-line p-6 sm:p-8">
            <div class="absolute -right-10 top-8 hidden rotate-6 sm:block">
              <div class="tape-label h-10 w-40 bg-climb-tape"></div>
              <div class="tape-label ml-16 mt-3 h-10 w-28 bg-grade-blue"></div>
              <div class="tape-label -ml-2 mt-3 h-10 w-36 bg-grade-pink"></div>
            </div>
            <p class="relative z-10 text-sm font-bold uppercase text-climb-tape">Dev gallery</p>
            <h1 class="climb-display relative z-10 mt-4 max-w-3xl text-4xl leading-none text-climb-chalk sm:text-6xl">
              Climb should feel like the gym feed after a good session.
            </h1>
            <p class="relative z-10 mt-5 max-w-2xl text-base leading-7 text-climb-chalk-soft">
        ...
        <section class="grid gap-6 lg:grid-cols-2">
          <div class="rounded-lg border border-climb-line bg-climb-panel p-6">
            <.header>
              Form Components
              <:subtitle>
