...
#
#     PHX_SERVER=true bin/ascents start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ascents, AscentsWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :ascents, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  # Email delivery is intentionally disabled for the first production MVP.
  # Auth uses password login, so the app must not require SMTP credentials to boot.
end
